...
| ------------------- | ------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------- |
| Custom Agents       | Hvilke verktøy den kan bruke, definert i `.github/agents` og `settings.json`.        | Lag en front-end developer agent, der AI-en kun kan generate og modify code relatert til front-end development.        |
...
| ------------------- | ------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| Custom Agents       | Which tools it can use, defined in `.github/agents` and `settings.json`.              | Create a front-end developer agent, where the AI can only generate and modify code related to front-end development.  |
